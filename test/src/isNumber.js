...
import {isNumber, isArray, isObject} from '../../src/index.js';
...
test(macro, 0, true);
test(macro, Number.NaN, true);
test(macro, Number.POSITIVE_INFINITY, true);
test(macro, Number.NEGATIVE_INFINITY, true);
